...
[Follow me on GitHub](https://github.com/pomartel/) and catch the back-story in [Finding My Spark](/posts/2025/finding-my-spark-again/).
...
Tip: Change my.omarchy.blog to steipete.md for the markdown version.
